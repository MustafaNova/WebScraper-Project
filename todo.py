 ...
 # produktdetails seite designen produkt (https://www.saturn.de/de/product/_apple-ipad-air-wi-fi-2025-7-generation-tablet-128-gb-11-zoll-blau-2984224.html):
  # obige leiste von saturnseite nachmachen(index.html):
   # wenn registriert soll in datenbank user info speichern(password soll hashen):
    ...
    # searchbar erstmal richtig machen, alle eventlistener dazu adden und prüfen obs klappt, django starten und mit entwicklertools alle eventlistener darauf identifizieren und alle einfügen in angular
    # navBar in angular einbauen, design, js funktionen webscraper wie umwandeln chatgpt fragen
    # navBar responsive einstellen, # resize funktionen in angular einbauen
    # aus navBar accountSlide rausnehmen, einzelne componente machen und in navBar einfügen
    # filtermenu jede slide als einzelne componente
    # Angular, alle html,css,js dateien von webscraper in angular komponenten machen
    # newDesignHtml registration ordner auch einbauen mit routing in angular
